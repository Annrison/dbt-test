...
-- to use this macro, replace the table references and primary key and dbt run-operation audit_helper_compare_column_values
...
{% if execute %}
  {% for column in columns_to_compare %}
    ...
    {{ log(audit_results.column_names, info=True) }}
